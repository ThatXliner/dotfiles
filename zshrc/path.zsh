NEW_PATH="$PYENV_ROOT/bin:$HOME/.local/bin:$HOME/bin:$HOME/.cargo/bin:$HOME/.gem/ruby/2.6.0/bin:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin"  # Add binary stuff
